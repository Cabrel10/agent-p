...
st.set_page_config(
    page_title="Morningstar Crypto Trading", page_icon="", layout="wide", initial_sidebar_state="expanded"
)
...
def main():
    ...
    if page == "Dashboard":
        ...
        if morningstar_exists:
            ...
            st.warning(
                "⚠️ Le modèle Morningstar n'est pas disponible. Vous pouvez le créer en exécutant le script `scripts/create_simple_model.py`."
            )
