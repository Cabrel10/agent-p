...
def get_performance_metrics():
    ...
    metrics_files = list(REPORTS_DIR.glob("**/evaluation_results.json")) + list(
        REPORTS_DIR.glob("**/test_results.json")
    )
...
def dashboard_page():
    ...
    with col4:
        create_metric_card(
            "Drawdown max", f"{performance_metrics.get('max_drawdown', 0)*100:.1f}%", delta_color="inverse"
        )
    ...
    actions = [
        {
            "timestamp": "2025-05-04 14:30:22",
            "action": "Collecte de donnu00e9es",
            "details": "BTC/USDT, ETH/USDT",
            "status": "Terminu00e9",
        },
        {
            "timestamp": "2025-05-04 13:45:10",
            "action": "Entrau00eenement du modu00e8le",
            "details": "simple_model",
            "status": "Terminu00e9",
        },
        {
            "timestamp": "2025-05-04 12:20:05",
            "action": "Normalisation des datasets",
            "details": "standardized_multi_crypto_dataset",
            "status": "Terminu00e9",
        },
        {
            "timestamp": "2025-05-04 11:15:30",
            "action": "Vu00e9rification du module de raisonnement",
            "details": "reasoning_module",
            "status": "Terminu00e9",
        },
        {
            "timestamp": "2025-05-04 10:05:12",
            "action": "Trading en direct",
            "details": "BTC/USDT",
            "status": "En cours",
        },
    ]
