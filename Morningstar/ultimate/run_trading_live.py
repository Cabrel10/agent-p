...
def create_default_config(config_path: str) -> None:
    ...
    logger.info(
        "IMPORTANT: Veuillez éditer ce fichier pour configurer vos clés API et autres paramètres avant de lancer le trading live."
    )
...
def main():
    ...
    parser.add_argument(
        "--config", type=str, default="config/trading_live.yaml", help="Chemin vers le fichier de configuration"
    )
    parser.add_argument("--create-config", action="store_true", help="Crée un fichier de configuration par défaut")
    parser.add_argument(
        "--interval",
        type=int,
        default=None,
    ...
    parser.add_argument(
        "--test-run", action="store_true", help="Exécute une seule itération pour tester la configuration"
    )
