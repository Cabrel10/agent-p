...
def main():
    ...
    parser.add_argument(
        "--exchange", type=str, default="bitget", choices=["bitget", "binance", "kucoin"], help="Exchange u00e0 tester"
    )
    parser.add_argument("--testnet", action="store_true", help="Utiliser le testnet")
    parser.add_argument("--symbol", type=str, default="BTC/USDT", help="Symbole de la paire u00e0 tester")
