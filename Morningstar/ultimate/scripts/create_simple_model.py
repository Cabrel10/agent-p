...
def create_simple_model(output_dir, model_name="morningstar"):
    ...
    try:
        ...
        instrument_embedding = tf.keras.layers.Embedding(
            input_dim=10, output_dim=8, name="instrument_embedding"  # Nombre d'instruments  # Dimension de l'embedding
        )(instrument_input)
        ...
        x = tf.keras.layers.Concatenate(name="feature_concat")([x_technical, x_llm, x_mcp, x_hmm, instrument_embedding])
        ...
        model = tf.keras.models.Model(
            ...
            outputs={"market_regime": market_regime_output, "sl_tp": sl_tp_output, "explanation": explanation_output},
        ...
        model.compile(
            ...
            metrics={"market_regime": ["accuracy"], "sl_tp": ["mae"]},
            loss_weights={"market_regime": 1.0, "sl_tp": 1.0, "explanation": 0.1},  # Poids faible pour l'explication
        )
        ...
        metadata = {
            ...
            "output_shapes": {"market_regime": 4, "sl_tp": 2, "explanation": 128},
            "reasoning_capabilities": {"explanation_vector": True, "chain_of_thought": True},
        }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default=str(BASE_DIR / "model" / "trained"),
        help="Répertoire où sauvegarder le modèle",
    )
    parser.add_argument("--model-name", type=str, default="morningstar", help="Nom du modèle")
