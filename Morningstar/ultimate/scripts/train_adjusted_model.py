...
def parse_args():
    ...
    parser.add_argument("--batch-size", type=int, default=32, help="Taille du batch d'entrau00eenement")
    parser.add_argument(
        "--validation-split", type=float, default=0.2, help="Proportion de donnu00e9es utilisu00e9es pour la validation"
    )
    parser.add_argument("--early-stopping", action="store_true", default=True, help="Utiliser l'early stopping")
