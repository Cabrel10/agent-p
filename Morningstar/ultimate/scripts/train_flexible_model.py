...
def parse_args():
    ...
    parser.add_argument("--batch-size", type=int, default=32, help="Taille du batch pour l'entraînement")
    parser.add_argument(
    ...
    parser.add_argument("--learning-rate", type=float, default=0.001, help="Taux d'apprentissage pour l'optimiseur")
...
def preprocess_data(df, dimensions):
    ...
    X = {"technical_input": X_tech, "llm_input": X_llm, "mcp_input": X_mcp, "hmm_input": X_hmm}

    y = {"signal": y_signal_onehot, "market_regime": y_regime_onehot, "sl_tp": y_sl_tp, "volatility_quantiles": y_vol}
