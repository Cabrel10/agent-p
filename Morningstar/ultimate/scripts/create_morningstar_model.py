    ...
    try:
        if use_reasoning:
            ...
            model = build_reasoning_model(
                ...
                ],  # Noms des features pour le décodage des explications
            )
        ...
        metadata = {
            ...
            "output_shapes": {"market_regime": 4, "sl_tp": 2},
        }
...
def main():
    ...
    parser.add_argument(
        "--use-reasoning", action="store_true", default=True, help="Utiliser le modèle avec capacité de raisonnement"
    )
