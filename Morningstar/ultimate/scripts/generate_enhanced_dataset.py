...
def generate_enhanced_dataset(
    input_path, output_path, add_sentiment=True, add_context=True, add_technical=True, add_cross_asset=True
):
    """
...
def main():
    ...
    parser.add_argument(
        "--no-technical", action="store_true", help="Ne pas ajouter d'indicateurs techniques supplémentaires"
    )
    parser.add_argument(
        "--no-cross-asset", action="store_true", help="Ne pas ajouter de features de corrélation entre actifs"
    )
